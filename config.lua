Config = {
    ...
    IT_LOCAL_RACE_MAX_BET = 5000, -- max. bet for the local race
    ...
    -- Lucky Wheel
    LUCKY_WHEEL_ENABLED = false, -- set to false, if you don't want to use Lucky Wheel
    ...
    -- Cashier
    CASHIER_DAILY_BONUS = 250, -- daily visitor bonus that players can request at the Cashier, set to 0 if you don't want any daily bonuses. def: 1000
    ...
    SocietyFramework = Society.OkokBanking,
    --[[
    ...
    -- Job
    BossGrade = 0, -- the max grade (boss) for the casino job
    BossName = "Besitzer",
